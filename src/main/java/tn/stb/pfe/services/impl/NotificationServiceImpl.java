...
import tn.stb.pfe.repositories.NotificationRepository;
...
@Service
public class NotificationServiceImpl implements tn.stb.pfe.services.NotificationService {

    private final NotificationRepository notificationRepository;
    private final UserService userService;
    //private final boolean mailingEnabled;

    public NotificationServiceImpl(/*@Value("${mailing.enabled}") boolean mailingEnabled,*/ NotificationRepository notificationRepository, UserService userService) {
